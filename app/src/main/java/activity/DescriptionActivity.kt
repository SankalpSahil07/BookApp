...
class DescriptionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        progressBarLayout = findViewById(R.id.progressBarRelativeLayout)
        progressBarLayout.visibility = View.VISIBLE
        progressBar = findViewById(R.id.progressBarRL)
                    ...
                    try {
                        ...
                        if (success) {
                               ...
                               if (isFav){
                                    ...
                                    val noFavColor = ContextCompat.getColor(application, R.color.teal_700)
